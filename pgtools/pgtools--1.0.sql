...
COMMENT ON COLUMN vacuum_needed.n_tup_ins IS 'inserted tuples number';
COMMENT ON COLUMN vacuum_needed.n_tup_upd IS 'updated tuples number';
COMMENT ON COLUMN vacuum_needed.n_tup_del IS 'deleted tuples number';
COMMENT ON COLUMN vacuum_needed.n_live_tup IS 'live tuples number';
COMMENT ON COLUMN vacuum_needed.n_dead_tup IS 'dead tuples number';
COMMENT ON COLUMN vacuum_needed.reltuples IS 'real tuples number';
COMMENT ON COLUMN vacuum_needed.athreshold IS 'vacuum threshold';
COMMENT ON COLUMN vacuum_needed.aneeded IS 'whether need vacuum';
COMMENT ON COLUMN vacuum_needed.pct_dead IS 'percent of dead tuples';
...
COMMENT ON COLUMN function_stats.self_call_time IS 'total executed time of direct calls';
COMMENT ON COLUMN function_stats.avg_time IS 'average time per calls';
COMMENT ON COLUMN function_stats.pct_functions IS 'percent call time of all functions';
...
COMMENT ON COLUMN repeated_indexes.key IS 'repeated index key';
COMMENT ON COLUMN repeated_indexes.idx_oid IS 'index oid';
COMMENT ON COLUMN repeated_indexes.idx_name IS 'index name';
COMMENT ON COLUMN repeated_indexes.indisprimary IS 'whether the index is primary';
COMMENT ON COLUMN repeated_indexes.idx_scan IS 'Number of index scans initiated on this index';
COMMENT ON COLUMN repeated_indexes.idx_tup_read IS 'Number of index entries returned by scans on this index';
COMMENT ON COLUMN repeated_indexes.idx_tup_fetch IS 'Number of live table rows fetched by simple index scans using this index';
COMMENT ON COLUMN repeated_indexes.idx_size IS 'index size';
...
COMMENT ON COLUMN query_statements.total_time IS 'total query runtime(second)';
COMMENT ON COLUMN query_statements.avg_time IS 'average query runtime(second)';
...
COMMENT ON COLUMN repl_stats.network_delay IS 'the delay size between master and slave in network';
COMMENT ON COLUMN repl_stats.slave_write IS 'the delay size between master and slave as slave write';
COMMENT ON COLUMN repl_stats.slave_replay IS 'the delay size between master and slave as slave read';
COMMENT ON COLUMN repl_stats.total_lag IS 'the total delay size between master and slave';
...
COMMENT ON COLUMN pgstat_io.total_tuple IS 'total used tuple';
COMMENT ON COLUMN pgstat_io.total_select IS 'total selected tuple';
COMMENT ON COLUMN pgstat_io.total_insert IS 'total inserted tuple';
COMMENT ON COLUMN pgstat_io.total_update IS 'total udpated tuple';
COMMENT ON COLUMN pgstat_io.total_delete IS 'total delete tuple';
...
COMMENT ON COLUMN bloat_indexes.index_scans IS 'index scans time';
COMMENT ON COLUMN bloat_indexes.bloat_pct IS 'bloat percent of index';
COMMENT ON COLUMN bloat_indexes.bloat_mb IS 'bloat size of index';
COMMENT ON COLUMN bloat_indexes.index_mb IS 'index size';
COMMENT ON COLUMN bloat_indexes.table_mb IS 'table size';
